...
to setup-constants
  set lifespan-summer 60
  set lifespan-winter 30
end
...
to setup-turtles
  create-turtles number-bees [
    setxy 0 0
    set age 30
    set max-age (random 30) + lifespan-summer
    set shape "bee"
  ]
end
...
to breed-turtles
  create-turtles number-bees * 2500 / 60000 [
...
"" ""
PENS
"bees" 1.0 0 -1184463 true "" "plot count turtles with [ age > 20 ]"
"larva" 1.0 0 -7500403 true "" "plot count turtles with [ age <= 20 ]"
